# Fully Homomorphic Encryption Part Three: Strawmans for the FHE Scheme
...
So what's the secret sauce that's missing from here? **Binary Decompositon** to the rescue!
